  ...
  return (
    <div className="min-h-screen bg-emerald-950 flex flex-col items-center justify-center px-6">
      ...
      {!selectedUser ? (
        ...
        <div className="w-full max-w-sm flex flex-col items-center animate-in fade-in slide-in-from-bottom-4 transform-gpu" style={{ WebkitBackfaceVisibility: "hidden", outline: "none" }}>
          <button
