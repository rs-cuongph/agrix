...
3. `READ gitnexus://repo/agrix/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/agrix/context` | Codebase overview, check index freshness |
| `gitnexus://repo/agrix/clusters` | All functional areas |
| `gitnexus://repo/agrix/processes` | All execution flows |
| `gitnexus://repo/agrix/process/{name}` | Step-by-step execution trace |
